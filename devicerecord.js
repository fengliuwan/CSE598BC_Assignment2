...
class DeviceRecord extends State {
  ...
  setDevice_Serial(newDevice_Serial) {
    return (this.device_serial = newDevice_Serial);
  }
  getPrice() {
    return this.price;
  }
  ...
  setManufacturing_date(newManufacturing_date) {
    return (this.manufacturing_date = newManufacturing_date);
  }
  getcompany() {
    return this.company;
  }
  ...
  setdevicetype(newdevicetype) {
    return (this.device_type = newdevicetype);
  }
  ...
  setLastUpdate(newlastupdate) {
    return (this.last_update = newlastupdate);
  }
